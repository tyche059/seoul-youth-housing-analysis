...
supply_ratio = (total_supply / total_demand) * 100
st.metric(label="서울시 청년 주택 수요 대비 공급 비율", value=f"{supply_ratio:.2f}%")
...
with col2:
    ...
    * **(분석결과 및 의견)** 실제 데이터를 조회해 보면 관악구, 마포구, 서대문구 등 주요 대학가 및 1인 가구 밀집 지역에서 수요 대비 공급이 턱없이 부족한 극심한 미스매치가 확인됩니다. 전체 수요량과 공급량을 원 그래프로 비교해 보면 공급이 얼마나 부족한지 시각적으로 강렬하게 체감할 수 있습니다. 핀셋형 공급 정책이 시급합니다.
    """)
